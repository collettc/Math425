...
### Section 3.6 <span id=recpoints>{6}</span><span id=report>{ 4/6 }</span>

### Section 3.7 <span id=recpoints>{7}</span><span id=report>{ 4/7 }</span>
...
### 3.4 <span id=recpoints>{6}</span><span id=report>{ 5/6 }</span>
