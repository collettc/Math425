...
### Section 3.1 <span id=recpoints>{2}</span><span id=report>{ / }</span>

### Section 3.2 <span id=recpoints>{2}</span><span id=report>{ / }</span>

### Section 3.3 <span id=recpoints>{8}</span><span id=report>{ / }</span>
...
### 3.1 <span id=recpoints>{2}</span><span id=report>{ / }</span>
...
### 3.3 <span id=recpoints>{6}</span><span id=report>{ / }</span>
...
### 3.4 <span id=recpoints>{6}</span><span id=report>{ / }</span>
