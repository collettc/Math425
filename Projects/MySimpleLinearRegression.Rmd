---
title: "Predicting the Happiness of Countries"
output: 
  html_document:
    theme: readable
    code_folding: hide
...
library(readr)
happiness <- read_csv("~/School/Fall 2017/MATH 325/Math 325 Notebook/Math 325 Notebook/Data/happinessindex.csv")
nochina <- read_csv("~/School/Fall 2017/MATH 325/Math 325 Notebook/Math 325 Notebook/Data/nochina.csv")
library(mosaic)
library(DT)
library(car)
library(pander)
